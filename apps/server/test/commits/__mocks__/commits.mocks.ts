export const commitListMock = [
  {
    ...
    node_id:
      "C_kwDOKy00BNoAKGJkNzVjZjhhY2M2NjQ0MTRkZjg5NWVkNWQ2MjNjMzQyNmIxNjczMjE",
    commit: {
      author: {
        name: "Santiago Javier Rubio",
        email: "s.rubio91@gmail.com",
    ...
    html_url:
      "https://github.com/SantiagoJavierRubio/git-commit-history/commit/bd75cf8acc664414df895ed5d623c3426b167321",
    parents: [
      {
